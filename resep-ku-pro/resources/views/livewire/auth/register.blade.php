<div class="min-h-screen flex items-center justify-center bg-orange-50 p-6 md:p-10 font-sans relative">
    ...
    <div
        ...
        <div class="w-full md:w-[55%] p-8 md:p-12 flex flex-col items-center bg-white">
            ...
            <form wire:submit.prevent="register" class="w-full space-y-3.5">
                ...
                <select wire:model="role"
                    ...
                    <option value="owner">Restaurant Owner / Head Chef</option>
                ...
                <div class="relative">
                    ...
                    <x-lucide-eye-off
                        class="absolute right-4 top-3 w-5 h-5 text-gray-300 cursor-pointer hover:text-orange-500 transition-colors" />
                </div>

                <button
                    class="w-full bg-[#1a1a1a] hover:bg-black text-white font-black py-3.5 rounded-xl shadow-lg transition-all uppercase tracking-[0.2em] mt-2 text-sm transform active:scale-[0.97]">
                    {{ __('Sign Up') }}
                </button>
            </form>
