<div class="min-h-screen flex items-center justify-center bg-orange-50 p-6 md:p-10 font-sans relative text-gray-900">
    ...
    <div
        ...
        <div class="w-full md:w-[55%] p-8 md:p-12 bg-white flex flex-col justify-center relative">
            ...
            <a href="/auth/google"
                ...
                <span class="group-hover:text-gray-900 transition-colors">{{ __('Login with Google') }}</span>
            </a>
